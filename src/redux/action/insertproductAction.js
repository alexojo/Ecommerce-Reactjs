...
export const registro=(imagePath, title, description, price, color, size, array_tags, Pregunta1, Pregunta2,cellphone)=>dispatch=>{
  dispatch({
  ...
  return serverCall({
    ...
    url:'/ingresoproducts',
    data:{
      imagePath, title, description, price, color, size, array_tags, Pregunta1, Pregunta2,cellphone
    }
  })
  .then(res=>{
    dispatch({
